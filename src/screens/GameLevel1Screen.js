...
import { View, Text, StyleSheet, Alert, Button, ImageBackground, TouchableOpacity, Image } from "react-native";
    ...
    return (
      ...
      <ImageBackground
        ...
        <View style={[Theme.w100, Theme.h93, Theme.justAlign]}>
          ...
          <View style={[Theme.w100, Theme.h10, Theme.justAlign, Theme.flexDirRow]}>
            <View style={[Theme.w5]} />
          ...
          <View style={[Theme.w90, Theme.h7, Theme.bgTransparent, Theme.justAlign]}>
            <Text style={[styles.timeText, Theme.fMain1]}>{formatTime(elapsedTime)}</Text>
          </View>
          ...
          <View style={[Theme.w75, Theme.h7, Theme.justAlign, Theme.flexDirRow]}>
            ...
            <View style={[Theme.w48, Theme.h100, Theme.justAlign]}>
              <TouchableOpacity
                style={[Theme.w100, Theme.h100, Theme.bgMain1, Theme.borderRadius40, Theme.justAlign]}
                onPress={startTimer}
              >
                <Text style={[Theme.fWhite, Theme.f17, Theme.txtAlignCenter, Theme.fBold]}>Start</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={[Theme.w48, Theme.h100, Theme.justAlign]}>
              <TouchableOpacity
                ...
                onPress={stopTimer}
              >
                <Text style={[Theme.fWhite, Theme.f17, Theme.txtAlignCenter, Theme.fBold]}>Stop</Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={[Theme.w90, Theme.h18, Theme.bgTransparent, Theme.justAlign]}>
            {/*CARD CONTENT--------------------------------------------------------------------------------------------*/}
            <View style={[Theme.w100, Theme.h100, Theme.bgTransparent, Theme.justAlign, Theme.flexDirRow]}>
              <View style={[Theme.w100, Theme.h100, Theme.justAlign, Theme.bgTransparent]}>
          ...
          <View style={[Theme.w75, Theme.h7, Theme.justAlign, Theme.flexDirRow]}>
            <TouchableOpacity
              style={[Theme.w60, Theme.h100, Theme.bgMain1, Theme.borderRadius40, Theme.justAlign]}
              onPress={replay}
            >
              <Text style={[Theme.fWhite, Theme.f17, Theme.txtAlignCenter, Theme.fBold]}>Repeat</Text>
            </TouchableOpacity>
          </View>
