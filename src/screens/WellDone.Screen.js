      ...
      <ImageBackground
        ...
        <View style={[Theme.w100, Theme.h70, Theme.justAlign]}>
          ...
          <View style={[Theme.w85, Theme.h40, Theme.justifyCenter]}>
            <Text style={[Theme.fRed, Theme.f70, Theme.fBold, Theme.txtAlignCenter, Theme.txtShadowOffset1, Theme.txtShadowColorBlack]}>
              WELL DONE
            </Text>
          </View>
          <View style={[Theme.w100, Theme.h40, Theme.flexDirRow, , Theme.justAlign]}>
            <Image
        ...
        <View style={[Theme.w90, Theme.h30, Theme.justAlign]}>
          <TouchableOpacity
            ...
            <Text style={[Theme.fWhite, Theme.f25, Theme.txtAlignCenter, Theme.fBold]}>Go to result</Text>
          </TouchableOpacity>
        </View>
