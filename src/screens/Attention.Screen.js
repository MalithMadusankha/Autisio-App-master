...
import { Image, Text, StyleSheet, View, ScrollView, SafeAreaView, TouchableOpacity } from "react-native";
        ...
        <SafeAreaView style={[Theme.w100, Theme.h100]}>
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            <GameCardComponent
              ...
              GAME_ON_PRESS={() => navigation.navigate('SelectSimilarAnimalScreen')}
            />
